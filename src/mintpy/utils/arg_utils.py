...
def add_gnss_argument(parser):
    ...
    gnss.add_argument('--show-gnss','--show-gps', dest='disp_gnss', action='store_true',
                      help='Show GNSS location within the coverage.')
    ...
    gnss.add_argument('--gnss-full-span', dest='gnss_vel_full_span', action='store_true',
                      help='Estimate GNSS velocity over the full GNSS time span for comparison with InSAR '
                           '(default: use the InSAR overlapping period).')
